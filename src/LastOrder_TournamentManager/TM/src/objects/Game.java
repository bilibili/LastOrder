...
public class Game implements Serializable
{
	...
	private String 			hostAllScore = "unknown";
	private String 			awayAllScore = "unknown";
	...
	public String getResultString() 
	{
		...
		s += " " + this.hostAllScore + " " + this.awayAllScore;
	...
	public void setHostAllScore(String data) { hostAllScore = data; }
	public void setAwayAllScore(String data) { awayAllScore = data; }

	public String getAwayAllScore() {
		return awayAllScore;
	}

	public String getHostAllScore() {
		return hostAllScore;
	}
	...
	public void updateWithGame(Game game) {
		if (gameID == game.getGameID()) {
			...
			if (game.getHostAllScore().equals("unknown") == false)
				setHostAllScore(game.hostAllScore);
			if (game.getAwayAllScore().equals("unknown") == false)
				setAwayAllScore(game.awayAllScore);
